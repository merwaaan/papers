...
\begin{figure}[p]
  ...
  \subfloat[]{\input{connexite0.tikz}}\\
  \subfloat[]{\input{connexite1.tikz}}\\
  \subfloat[]{\input{connexite2.tikz}}
...
\begin{figure}[p]
  ...
  \subfloat[]{\input{connexite3.tikz}}\\
  \subfloat[]{\input{connexite4.tikz}}\\
  \subfloat[]{\input{connexite5.tikz}}
...
\begin{figure}[p]
  ...
  \subfloat[]{\input{connexite6.tikz}}\\
  \subfloat[]{\input{connexite7.tikz}}
